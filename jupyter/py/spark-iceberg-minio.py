...
conf = (
    ...
    .set("spark.sql.catalog.demo.warehouse", os.getenv("WAREHOUSE", "s3a://warehouse/"))
    .set("spark.sql.catalog.demo.s3.endpoint", os.getenv("AWS_S3_ENDPOINT", "http://minio:9000"))
